...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <title>{{ config('Magical Kenya Tembo Naming Festival (MKTNF) | Kenya Wildlife Service', 'Magical Kenya Tembo Naming Festival') }} Magical Kenya Tembo Naming Festival</title>
            ...
            <nav class="navbar navbar-expand-md navbar-light shadow-smX d-block fixed-top" id="tembo">
                ...
                <div class="top_global_nav container d-flex">
                    ...
                    <div class="tg_end d-flex">
                            ...
                            <a class="nav-link header__buttonX buttonX btn btn-primary" style="color:white; background-color: #e96559;" href="{{ url('/corporate') }}#donate"><i class="fas fa-heart"></i> {{ __('Donate Online ') }}</a>
                    </div>
                </div>
                ...
                <div class="container d-flex">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav mr-autoX main-app-nav">
                            @guest
                             <li class="nav-item">
                                <a class="nav-link" href="{{ route('tembo-festival') }}">{{ __('Home') }}</a>
                            </li>            
                            <li class="dropdown">
                                <a id="dropdownMenu3" class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ __('Adopt and Name ') }} <span class="caret"></span></a>

                                <div class="dropdown-menu" aria-labelledby="dropdownMenu3">
                                    <a class="dropdown-item " href="{{ route('adobt-programe') }}">
                                        {{ __('What is Adopt & Name') }}
                                    </a>

                                    <a class="dropdown-item" href="{{ route('adopt') }}">
                                        {{ __('How to Adopt and name') }}
                                    </a> 
                                      <a class="dropdown-item" href="{{ route('tembo-festival') }}">
                                        {{ __('More Ways to Support ') }}
                                    </a> 
                                     
                                <a class="dropdown-item" href="{{ route('faq') }}">{{ __("Donate") }}</a>
                           
                                </div>
                            </li>
                               <li class="dropdown">
                                <a id="dropdownMenu3" class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ __('Legacy') }} <span class="caret"></span></a>
                              ...
                              <li class="dropdown">
                                <a id="dropdownMenu3" class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ __('WALL OF FAME') }} <span class="caret"></span></a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('corporate') }}">{{ __('Tembo Shop') }}</a>
                            </li>
                           <li class="nav-item">
                                <a class="nav-link" href="{{ route('corporate') }}">{{ __('Donate') }}</a>
                            </li>
                            @else
                            <li class="nav-item">
