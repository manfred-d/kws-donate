                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.campaigns.update", [$campaign->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $campaign->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $campaign->description) !!}</textarea>
