                ...
                <form class="booking-form" id="myForm" action="/donate">
                    <div class="row">
                        <div class="col-lg-12 d-flex flex-column">
                            <select class="app-select form-control form__select form-control select2 {{ $errors->has('campaign') ? 'is-invalid' : '' }}"  name="campaign_id" id="campaign_id" required>
                                
                                {{$campaigns = App\Models\Campaign::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '') }}
