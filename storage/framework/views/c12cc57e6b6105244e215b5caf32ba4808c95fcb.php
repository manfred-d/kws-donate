...
<div class="container">
                    ...
                    <div class="col-md-8">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-mpesa" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                ...
                                <form method="POST" class="form"  action="<?php echo e(route('lipa')); ?>">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="col-12-sm">
                                            <div class="form-group">
                                                <div class="input-wrap">
                                                    ...
                                                    <input type="hidden" name="account" value="<?php echo e($transaction->ref); ?>">
  ...
  <div class="pay-section">
                                        <button class="form-control" type="submit" name="mpesa">Send payment request for KES <?php echo e($transaction->amount*108); ?></button>
                                    </div>
                                    </div>
  ...
  <div class="card-body">
      ...
      <p>Account:   <?php echo e($transaction->ref); ?></p>
       <p>Amount:   <?php echo e($transaction->amount); ?></p>
  </div>
</div>
                                <form class="form">
                                    ...
                                    <div class="pay-section">
                                        <button class="form-control" type="submit">Validate payment request for KES <?php echo e($transaction->amount); ?></button>
                                    </div>
                                </form>
                                                ...
                                                <div class="input-wrap">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div id="paymentDetailsSection" class="section">
                                                            ...
                                                            <span class="form__label-text">Reference Number:<?php echo e($transaction->ref); ?></span><input class="form__field" type="hidden" name="reference_number" value="<?php echo e($transaction->ref); ?>" size="25"readonly><br/>
                                                            <span class="form__label-text">Amount:<?php echo e($transaction->amount); ?></span><input class="form__field" type="hidden" name="amount" size="25" value="<?php echo e($transaction->amount); ?>" readonly><br/>
                                                            <span class="form__label-text">Currency:<?php echo e($transaction->donation->currency ?? ''); ?></span><input class="form__field" type="hidden" value="<?php echo e($transaction->donation->currency ?? ''); ?>" name="currency" size="25" readonly><br/>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kikosico/public_html/projects/kws-donate/resources/views/frontend/transactions/pay.blade.php ENDPATH**/ ?>