...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <head>
        ...
        <title><?php echo e(config('Magical Kenya Tembo Naming Festival (MKTNF) | Kenya Wildlife Service', 'Magical Kenya Tembo Naming Festival')); ?> Magical Kenya Tembo Naming Festival</title>
    ...
    <body>
        <div id="app">
            <nav class="navbar navbar-expand-md navbar-light shadow-smX d-block fixed-top" id="tembo">
                ...
                <div class="top_global_nav container d-flex">
                    ...
                    <div class="tg_end d-flex">
                            ...
                            <a class="nav-link header__buttonX buttonX btn btn-primary" style="color:white; background-color: #e96559;" href="<?php echo e(url('/corporate')); ?>#donate"><i class="fas fa-heart"></i> <?php echo e(__('Donate Online ')); ?></a>
                    </div>
                </div>
                ...
                <div class="container d-flex">
                    <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                        ...
                        <img alt="KWS (@kwskenya) | Twitter" class="n3VNCb" src="/img/tembo-logo2.png" data-noaft="1" jsname="HiaYvf" jsaction="load:XAeZkd;" style="width: 221px; height:91px;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav mr-autoX main-app-nav">
                            <?php if(auth()->guard()->guest()): ?>
                             <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('tembo-festival')); ?>"><?php echo e(__('Home')); ?></a>
                            </li>            
                            <li class="dropdown">
                                <a id="dropdownMenu3" class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(__('Adopt and Name ')); ?> <span class="caret"></span></a>

                                <div class="dropdown-menu" aria-labelledby="dropdownMenu3">
                                    <a class="dropdown-item " href="<?php echo e(route('adobt-programe')); ?>">
                                        <?php echo e(__('What is Adopt & Name')); ?>

                                    </a>

                                    <a class="dropdown-item" href="<?php echo e(route('adopt')); ?>">
                                        <?php echo e(__('How to Adopt and name')); ?>

                                    </a> 
                                      <a class="dropdown-item" href="<?php echo e(route('tembo-festival')); ?>">
                                        <?php echo e(__('More Ways to Support ')); ?>

                                    </a> 
                                     
                                <a class="dropdown-item" href="<?php echo e(route('faq')); ?>"><?php echo e(__("Donate")); ?></a>
                           
                                </div>
                            </li>
                               <li class="dropdown">
                                <a id="dropdownMenu3" class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(__('Legacy')); ?> <span class="caret"></span></a>

                                <div class="dropdown-menu" aria-labelledby="dropdownMenu3">
                                    <a class="dropdown-item " href="<?php echo e(route('endoment-fund')); ?>">
                                        <?php echo e(__('Named Elephants ')); ?>
                              ...
                              <li class="dropdown">
                                <a id="dropdownMenu3" class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(__('WALL OF FAME')); ?> <span class="caret"></span></a>

                                <div class="dropdown-menu" aria-labelledby="dropdownMenu3">
                                    <a class="dropdown-item " href="<?php echo e(route('endoment-fund')); ?>">
                                        <?php echo e(__('Wall of Fame ')); ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('corporate')); ?>"><?php echo e(__('Tembo Shop')); ?></a>
                            </li>
                           <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('corporate')); ?>"><?php echo e(__('Donate')); ?></a>
                            </li>
                            <?php else: ?>
                            <li class="nav-item">
...
</html><?php /**PATH /home/kikosico/public_html/projects/kws-donate/resources/views/layouts/tembo.blade.php ENDPATH**/ ?>