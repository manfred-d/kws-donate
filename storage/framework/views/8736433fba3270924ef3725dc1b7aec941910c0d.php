    ...
    <div class="col-md-6">
        <div class="card mx-4">
            <div class="card-body p-4">
                <h1 class="text-center">                       <img alt="KWS (@kwskenya) | Twitter" class="n3VNCb" src="/img/kws-logo.png" data-noaft="1" jsname="HiaYvf" jsaction="load:XAeZkd;" style="width: 159px; height:auto; margin: 0px;text-align: center;">
</h1>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kikosico/public_html/projects/kws-donate/resources/views/auth/login.blade.php ENDPATH**/ ?>