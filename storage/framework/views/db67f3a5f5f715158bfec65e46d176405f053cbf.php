...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.faq-questions.update", [$faqQuestion->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('category') ? 'is-invalid' : ''); ?>" name="category_id" id="category_id" required>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((old('category_id') ? old('category_id') : $faqQuestion->category->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control <?php echo e($errors->has('question') ? 'is-invalid' : ''); ?>" name="question" id="question" required><?php echo e(old('question', $faqQuestion->question)); ?></textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control <?php echo e($errors->has('answer') ? 'is-invalid' : ''); ?>" name="answer" id="answer" required><?php echo e(old('answer', $faqQuestion->answer)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kikosico/public_html/projects/kws-donate/resources/views/admin/faqQuestions/edit.blade.php ENDPATH**/ ?>