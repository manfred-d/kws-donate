    ...
    <div class="container">
        ...
        <form method="POST" action="/cdonate" enctype="multipart/form-data"  class="form donation-form">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8">
                    <select class="form__select form-control select2 <?php echo e($errors->has('campaign') ? 'is-invalid' : ''); ?>"  name="campaign_id" id="campaign_id" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kikosico/public_html/projects/kws-donate/resources/views/corporate.blade.php ENDPATH**/ ?>