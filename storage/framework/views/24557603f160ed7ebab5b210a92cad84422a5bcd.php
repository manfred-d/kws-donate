    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route('admin.faq-questions.create')); ?>">
                <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.faqQuestion.title_singular')); ?>
...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('cruds.faqQuestion.title_singular')); ?> <?php echo e(trans('global.list')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kikosico/public_html/projects/kws-donate/resources/views/admin/faqQuestions/index.blade.php ENDPATH**/ ?>