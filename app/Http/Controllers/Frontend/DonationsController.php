...
class DonationsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.donations.create', compact('donors', 'campaigns'));
    }
    ...
    public function edit(Donation $donation)
    {
        ...
        return view('frontend.donations.edit', compact('donors', 'campaigns', 'donation'));
    }
    ...
    public function show(Donation $donation)
    {
        ...
        return view('frontend.donations.show', compact('donation'));
    }
