...
class AdoptionsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.adoptions.index', compact('adoptions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.adoptions.create', compact('adpotees', 'transactions', 'animals'));
    }
    ...
    public function store(StoreAdoptionRequest $request)
    {
        ...
        return redirect()->route('frontend.adoptions.index');
    }
    ...
    public function edit(Adoption $adoption)
    {
        ...
        return view('frontend.adoptions.edit', compact('adpotees', 'transactions', 'animals', 'adoption'));
    }
    ...
    public function show(Adoption $adoption)
    {
        ...
        return view('frontend.adoptions.show', compact('adoption'));
    }
